...
import type { CountOptions, DeleteOptions, EntityManagerType, FindOneOptions, FindOneOrFailOptions, FindOptions, IDatabaseDriver, LockOptions, UpdateOptions, GetReferenceOptions } from './drivers';
import type { AnyEntity, AutoPath, Dictionary, EntityData, EntityDictionary, EntityDTO, EntityMetadata, EntityName, FilterQuery, GetRepository, Loaded, New, Primary, RequiredEntityData } from './typings';
...
export declare class EntityManager<D extends IDatabaseDriver = IDatabaseDriver> {
     ...
     */
    create<T extends AnyEntity<T>, P extends string = never>(entityName: EntityName<T>,  options?: CreateOptions): New<T, P>;
    /**
